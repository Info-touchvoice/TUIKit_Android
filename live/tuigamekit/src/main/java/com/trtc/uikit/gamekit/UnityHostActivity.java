...
public class UnityHostActivity extends Activity implements IUnityPlayerLifecycleEvents {
    protected LiteGameUnityPlayer mUnityPlayer; // don't change the name of this variable; referenced from native code
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mUnityPlayer = LiteGameUnityPlayer.getUnityPlayer(this);
        setContentView(mUnityPlayer);
        mUnityPlayer.requestFocus();

//        unityContainer.addView(mUnityPlayer, new ViewGroup.LayoutParams(
...
//        mUnityPlayer.requestFocus();
        ...
        {
            sceneName = "GameAScene";
        }

        UnityPlayer.UnitySendMessage("GameManager", "OpenScene", sceneName);
        UnityHostBridge.setHostActivity(this);
    }
    ...
    @Override protected void onDestroy ()
    {
        ...
        super.onDestroy();
        UnityHostBridge.clearHostActivity();
    }
